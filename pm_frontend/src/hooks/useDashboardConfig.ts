...
export const DEFAULT_LAYOUTS: DefaultLayoutMap = {
  ...
  team_project:          { x: 59,  y: 0,   w: 25,  h: 25,  minW: 12,  minH: 20 },
  team_task:             { x: 59,  y: 25,  w: 25,  h: 25,  minW: 12,  minH: 20 },
  team_pending:          { x: 59,  y: 50,  w: 25,  h: 28,  minW: 12,  minH: 20 },
  team_size:             { x: 40,  y: 79,  w: 19,  h: 22,  minW: 12,  minH: 12 },
  daily_report_status:   { x: 59,  y: 78,  w: 25,  h: 23,  minW: 12,  minH: 12 },
  team_task_pie:         { x: 40,  y: 101, w: 40,  h: 70,  minW: 12,  minH: 20 },
  member_task_chart:     { x: 0,   y: 122, w: 40,  h: 49,  minW: 12,  minH: 20 },
  member_detail:         { x: 84,  y: 0,   w: 36,  h: 50,  minW: 12,  minH: 20 },
  team_project_status:   { x: 0,   y: 79,  w: 40,  h: 43,  minW: 12,  minH: 20 },
  team_project_progress: { x: 84,  y: 50,  w: 36,  h: 51,  minW: 12,  minH: 20 },
  team_log_today:        { x: 0,   y: 171, w: 120, h: 60,  minW: 12,  minH: 20 },
  team_review_types:     { x: 80,  y: 101, w: 40,  h: 70,  minW: 12,  minH: 20 },
